...
const Toast: React.FC<ToastProps> = ({ message, type, duration = 5000, onClose }) => {
  ...
  return (
    <div
      className={`flex items-center gap-3 px-4 py-3 rounded-lg border-2 shadow-lg transition-all duration-300 ${isExiting ? 'opacity-0 translate-y-2' : 'opacity-100 translate-y-0'
        } ${getTypeStyles()}`}
    >
