            ...
            {getPageNumbers().map((page, index) => {
              ...
              return (
                <button
                  ...
                  disabled={isLoading}
                  className={`relative inline-flex items-center px-4 py-2 text-sm font-semibold focus:z-20 focus:outline-offset-0 disabled:cursor-not-allowed transition-all ${isActive
