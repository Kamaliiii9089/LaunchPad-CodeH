        ...
        <div className="container container-sm">
          <div className="auth-container">
            <div className="auth-header">
              ...
              <h1>Welcome to Gmail Subscription Manager!</h1>
      ...
      <div className="container container-sm">
        <div className="auth-container">
          <div className="auth-header">
            ...
            <p>Start managing your digital subscriptions today</p>
          </div>
          ...
          <div className="auth-form">
            ...
            <div className="auth-benefits">
              ...
              <ul>
                <li><FiCheckCircle /> Automatic subscription discovery</li>
                <li><FiCheckCircle /> Easy access management</li>
                <li><FiCheckCircle /> Privacy-focused scanning</li>
                <li><FiCheckCircle /> Detailed analytics dashboard</li>
              </ul>
            </div>
            ...
            <p className="auth-note">
              ...
              We'll only access email metadata to identify subscriptions.
            </p>
          </div>
        ...
        <div className="auth-features">
          <div className="feature">
            ...
            <div>
              <h4>Smart Email Analysis</h4>
              <p>AI-powered detection of subscriptions and signups</p>
            </div>
          </div>
          <div className="feature">
            ...
            <div>
              ...
              <p>OAuth 2.0 with end-to-end encryption</p>
            </div>
          </div>
        </div>
      </div>
